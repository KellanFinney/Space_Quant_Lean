"""
Download TSLA data from Yahoo Finance and convert to LEAN format (zipped)
"""
...
def download_and_save(ticker, start_date, end_date, output_dir):
    ...
    print(f"Saved {len(lean_data)} rows to {zip_path}")

# Download TSLA daily data
download_and_save(
    "TSLA", 
    "2010-06-29",  # TSLA IPO date
    "2025-01-01",
    "/Users/kfinney89/Documents/QuantConnect/Data/equity/usa/daily"
)

print("\nDone! TSLA daily data is ready for LEAN.")
